...
export const user = {name: "Serhii"}
export const dashboardStats = {
  totalUsers: 12345,
  usersJoined: {currentMonth: 230, lastMonth: 155},
  totalTrips: 3521,
  tripsCreated: {currentMonth: 130, lastMonth: 155},
  userRole: {total: 62, currentMonth: 32, lastMonth: 15},
}
